...
- **Lyrics are sung literally.** MiniMax performs the `lyrics` field verbatim, so keywords must be expanded into a full structured song before generating. Ceiling is 3,000 characters (MiniMax's guide says 1,000 and its API reference says 3,000 — unresolved; we target ~900 and cap at 3,000).
