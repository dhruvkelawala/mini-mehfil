...
<meta name="twitter:card" content="summary_large_image"><meta name="twitter:title" content="${escapeHtml(song.title)} · Mini Mehfil"><meta name="twitter:description" content="${escapeHtml(description)}">${imageMetadata}
<style nonce="${nonce}">
