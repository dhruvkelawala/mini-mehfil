/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=share/wrangler.jsonc` (hash: e016e7a617b371f9a428bf91a63b6974)
...
interface __BaseEnv_Env {
	...
	ROOMS: DurableObjectNamespace<import("./src/worker/index").MehfilRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "MehfilRoom";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MEHFIL_PUBLIC_URL">> {}
}
